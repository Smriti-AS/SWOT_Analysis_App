...
# ✅ Function to Format SWOT as a Table
def format_swot_table(swot_text):
    ...
    # Ensure all lists are the same length by adding empty values where needed
...
if st.button("Generate SWOT"):
    ...
    st.markdown(swot_text, unsafe_allow_html=True)  # Render Markdown properly
